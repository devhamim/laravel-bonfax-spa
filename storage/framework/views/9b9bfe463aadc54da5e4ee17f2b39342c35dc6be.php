            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.setting.service.update')); ?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" name="price" value="<?php echo e($notice->price); ?>" class="form-control">
                            <input type="hidden" name="notice_id" value="<?php echo e($notice->id); ?>" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Description</label>
                            <textarea type="text" rows="3" name="description" value="<?php echo e($notice->description); ?>" class="form-control"><?php echo e($notice->description); ?></textarea>
                        </div>

                        <div class="form-group">
                            <label>Service Details</label>
                            <textarea type="text" name="service_details" rows="3" value="<?php echo e($notice->service_details); ?>"
                                class="form-control"><?php echo e($notice->service_details); ?></textarea>
                        </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\beauty spa\Anandadhara\resources\views/backend/content/settings/service/edit.blade.php ENDPATH**/ ?>