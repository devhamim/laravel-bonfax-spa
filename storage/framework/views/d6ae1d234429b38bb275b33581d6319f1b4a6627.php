                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('admin.setting.secrets.store')); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="secrets_des" id="secrets_des" cols="30" rows="5" class="form-control"
                                placeholder="Description*"></textarea>
                        </div>

                        <div class="form-group">
                            <label>About Image</label>
                            <input type="file" name="secrets_img" class="form-control">
                        </div>
                        <div class="form-group">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $secrets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secret): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><img src="<?php echo e(asset('backend_img/secrets')); ?>/<?php echo e($secret->secrets_img); ?>"
                                        style="height: 100px">
                                </td>
