<?php $__env->startSection('content'); ?>
    <section class="tf__breadcrumb"
        style="background: url(<?php echo e(asset('backend_img/blogs')); ?>/<?php echo e($blogs_details->first()->blog_ban_img); ?>);">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="header_info d-flex flex-wrap justify-content-between mt-3">
                        ...
                        <li><i class="far fa-calendar-alt"
                                aria-hidden="true"></i><?php echo e($blogs_details->first()->created_at->format('d-M-Y')); ?>

                        </li>
                        <li></li>
                    </ul>
                    <p class="mt-3"><?php echo e($blogs_details->first()->blog_sort); ?></p>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-12">
