                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.setting.secrets.update')); ?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="title" value="<?php echo e($secrets->title); ?>" class="form-control"
                                placeholder="Title*">
                        </div>
                        <div class="form-group">
                            <label>Video</label>
                            <input type="text" name="video" value="<?php echo e($secrets->video); ?>" class="form-control"
                                placeholder="Video*">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="secrets_img"
                                class="form-control"value="<?php echo e($secrets->secrets_img); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="secrets_img_l" class="form-control"
                                value="<?php echo e($secrets->secrets_img_l); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="secrets_img_r" class="form-control"
                                value="<?php echo e($secrets->secrets_img_r); ?>">
