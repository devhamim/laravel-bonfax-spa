    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('admin.setting.service.store')); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="3" name="description[]" class="form-control" placeholder="Service Title"></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $multis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $multi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><img src="<?php echo e(asset('/setting/banner/' . $multi->ban_img)); ?>" style="height: 100px"></td>
                                <td><?php echo e($multi->title ?? null); ?></td>

                                <td><img src="<?php echo e(asset('/setting/banner/' . $multi->service_image)); ?>"
                                        style="height: 100px"></td>
                                <td><?php echo e($multi->price ?? null); ?> Tk</td>
                                <td><?php echo e($multi->description ?? null); ?></td>
                                <td><?php echo e($multi->service_details ?? null); ?></td>
                                ...
                                <td>
                                    <a href="/admin/setting/service/edit/<?php echo e($multi->id); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\beauty spa\Anandadhara\resources\views/backend/content/settings/service/index.blade.php ENDPATH**/ ?>