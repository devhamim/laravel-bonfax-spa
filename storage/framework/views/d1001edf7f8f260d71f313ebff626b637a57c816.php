    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.setting.video.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="ban_img" value="<?php echo e($videos->ban_img); ?>" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Video thumbnail</label>
                            <input type="file" name="thumbnail" value="<?php echo e($videos->ban_img); ?>" class="form-control">
                        </div>
