                ...
                <div class="card-body">
                    <form action="{{ route('admin.setting.service.update') }}" enctype="multipart/form-data" method="POST">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text" name="ban_title" value="{{ $notice->ban_title }}" class="form-control"
                                placeholder="Title">
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" name="price" value="{{ $notice->price }}" class="form-control">
                            <input type="hidden" name="notice_id" value="{{ $notice->id }}" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Service Title</label>
                            <textarea type="text" rows="3" name="description" value="{{ $notice->description }}" class="form-control">{{ $notice->description }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Service Details</label>
                            <textarea type="text" name="service_details" rows="3" value="{{ $notice->service_details }}"
                                class="form-control">{{ $notice->service_details }}</textarea>
                        </div>
