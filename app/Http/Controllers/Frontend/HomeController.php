...
class HomeController
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('shedules','images','projects','product','pricings','videos','secrets', 'sliders','teams', 'event', 'brands', 'services','services_all', 'testmonies', 'blogs', 'projects', 'service_count', 'service_header'));
    }
...
// services_details start

function services_details($id){
    $service_details = Service::where('id', $id)->get();
    return view('frontend.content.services_details', [
        'service_details'=>$service_details,
    ]);
}

// services_details end
